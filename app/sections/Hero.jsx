...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col relative" id="about">
      ...
      <div className="w-full h-full absolute inset-0 mt-9">
        <Canvas className="w-full h-full ">
          <Suspense fallback={<CanvasLoader />}>
            ...
            <group>
              <Target className="mb-16" position={sizes.targetPosition} rotation={[0,Math.PI/5,0]} />
      ...
      <div className="absolute bottom-7 left-0 right-0 w-full z-10 c-space pt-9 mt-20">
        <Link href={'#contact'} >
